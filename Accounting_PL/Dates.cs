...
namespace VFPToolkit
{
	...
	public class Dates
	{
		...
		/// </summary>
		/// <returns></returns>
		public static DateTime CTOT(string cDateTime)
		{
		...
		/// <returns></returns>
		public static string CDOW(DateTime dDate)
		{
		...
		/// <param name="dDate"></param>
		/// <returns></returns>
		public static string CMonth(DateTime dDate)
		{
		...
		/// <returns></returns>
		public static DateTime CTOD(string tcDate)
		{
